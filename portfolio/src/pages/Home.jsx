...
import snowboard from '../assets/snowboard_clip.jpeg';
import graduation from '../assets/graduation.jpeg';
import black_templa from '../assets/black_templa.jpeg';
...
const Home = () => {
    ...
    <>
      ...
      <div className='justify-center items-center mt-10 mb-4 m-auto w-1/2'> 
        <div className='flex justify-center items-center mt-10 mb-4 text-bold-3l text-5xl uppercase'>
          <h2>projects</h2>
        </div >   
      </div>
